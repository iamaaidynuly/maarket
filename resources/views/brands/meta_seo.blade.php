...
@section('content')
    @component('adminlte::page', ['title' => 'Редактирование SEO'])
        ...
        <br>
        <br>
        <form method="POST" action="{{ url('/admin/brands/seo/' .$brands->id.'/update') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="tab-content" id="custom-tabs-one-tabContent">
                <div class="tab-pane fade active in" id="custom-tabs-one-ru" role="tabpanel" aria-labelledby="custom-tabs-one-ru-tab">
                    <div class="form-group {{ $errors->has('meta_title.ru') ? 'has-error' : ''}}">
                        ...
                        <input class="form-control" name="meta_title[ru]" type="text" id="meta_title_ru" value="{{ isset($brands->metaTitle->ru) ? $brands->metaTitle->ru : old('meta_title.ru')}}">
                    ...
                    <div class="form-group {{ $errors->has('content.ru') ? 'has-error' : ''}}">
                        ...
                        <input class="form-control" name="meta_description[ru]" type="text" id="content" value="{{ isset($brands->metaDesc->ru) ? $brands->metaDesc->ru : old('meta_description.ru')}}" >
                ...
                <div class="tab-pane fade" id="custom-tabs-one-en" role="tabpanel" aria-labelledby="custom-tabs-one-en-tab">
                    <div class="form-group {{ $errors->has('meta_title.en') ? 'has-error' : ''}}">
                        ...
                        <input class="form-control" name="meta_title[en]" type="text" id="meta_title_en" value="{{ isset($brands->metaTitle->en) ? $brands->metaTitle->en : old('meta_title.en')}}" >
                    ...
                    <div class="form-group {{ $errors->has('meta_description.en') ? 'has-error' : ''}}">
                        ...
                        <input class="form-control" name="meta_description[en]" type="text" id="meta_description_en" value="{{ isset($brands->metaDesc->en) ? $brands->metaDesc->en : old('meta_description.en')}}" >
                ...
                <div class="tab-pane fade" id="custom-tabs-one-kz" role="tabpanel" aria-labelledby="custom-tabs-one-kz-tab">
                    <div class="form-group {{ $errors->has('meta_title.kz') ? 'has-error' : ''}}">
                        ...
                        <input class="form-control" name="meta_title[kz]" type="text" id="meta_title_kz" value="{{ isset($brands->metaTitle->kz) ? $brands->metaTitle->kz : old('meta_title.kz')}}" >
                    ...
                    <div class="form-group {{ $errors->has('meta_description.kz') ? 'has-error' : ''}}">
                        ...
                        <input class="form-control" name="meta_description[kz]" type="text" id="meta_description_kz" value="{{ isset($brands->metaDesc->kz) ? $brands->metaDesc->kz : old('meta_description.kz')}}" >
