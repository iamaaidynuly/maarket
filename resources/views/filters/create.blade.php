@extends('adminlte::layout.main', ['title' => 'Добавить фильтр'])

@section('content')
    @component('adminlte::page', ['title' => 'Добавить фильтр'])
        @component('adminlte::box')
            <div class="col-md-12">
                ...
                <form method="POST" action="{{ url('/admin/filters') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}
    
                    @include ('filters.form', ['formMode' => 'create'])
