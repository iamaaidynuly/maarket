...
@section('content')
    @component('adminlte::page', ['title' => 'Добавление блока'])
        @component('adminlte::box')
            <div class="md-12">
{{--                <a href="{{ route('about-us-block.index') }}" title="Назад">--}}
...
{{--                    </button>--}}
                ...
                <form method="POST" action="{{ route('about-us-block.store') }}" accept-charset="UTF-8"
                      class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}

                    @include ('about.form', ['formMode' => 'create'])
                </form>
            </div>
