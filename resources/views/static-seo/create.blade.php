    ...
    @component('adminlte::page', ['title' => 'SEO'])
        @component('adminlte::box')
            <div class="col-md-12">
                ...
                <form method="POST" action="{{ url('/admin/static-seo') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}

                    @include ('static-seo.form', ['formMode' => 'create'])
