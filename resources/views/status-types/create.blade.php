        ...
        @component('adminlte::box')
            @include('flash-message')
                <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/admin/status-types') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}

                            @include ('status-types.form', ['formMode' => 'create'])
