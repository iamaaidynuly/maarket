...
@section('content')
    @component('adminlte::page', ['title' => 'Редактирование SEO'])
        ...
        <br>
        <br>
        <form method="POST" action="{{ url('/admin/contacts/seo/' .$contacts->id.'/update') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="tab-content" id="custom-tabs-two-tabContent">
                <div class="tab-pane fade active in" id="custom-tabs-two-home" role="tabpanel" aria-labelledby="custom-tabs-two-home-tab">
                    <div class="form-group {{ $errors->has('meta_title.ru') ? 'has-error' : ''}}">
                        ...
                        <input class="form-control" name="meta_title[ru]" type="text" id="meta_title_ru" value="{{ isset($contacts->metaTitle->ru) ? $contacts->metaTitle->ru : old('meta_title.ru')}}">
                    ...
                    <div class="form-group {{ $errors->has('content.ru') ? 'has-error' : ''}}">
                        ...
                        <input class="form-control" name="meta_description[ru]" type="text" id="content" value="{{ isset($contacts->metaDesc->ru) ? $contacts->metaDesc->ru : old('meta_description.ru')}}" >
                ...
                <div class="tab-pane fade" id="custom-tabs-two-profile" role="tabpanel" aria-labelledby="custom-tabs-two-profile-tab">
                    <div class="form-group {{ $errors->has('meta_title.en') ? 'has-error' : ''}}">
                        ...
                        <input class="form-control" name="meta_title[en]" type="text" id="title" value="{{ isset($contacts->metaTitle->en) ? $contacts->metaTitle->en : old('meta_title.en')}}" >
                    ...
                    <div class="form-group {{ $errors->has('meta_description.en') ? 'has-error' : ''}}">
                        ...
                        <input class="form-control" name="meta_description[en]" type="text" id="meta_description_en" value="{{ isset($contacts->metaDesc->en) ? $contacts->metaDesc->en : old('meta_description.en')}}" >
