...
<div class="tab-content" id="custom-tabs-one-tabContent">
    <div class="tab-pane fade active in" id="custom-tabs-one-ru" role="tabpanel"
        ...
        <div class="form-group col-md-6 {{ $errors->has('title.ru') ? 'has-error' : ''}}">
            <label for="title_ru" class="control-label">{{ 'Название страны Ru' }}</label>
            <input class="form-control" name="title[ru]" type="text" id="title_ru"
                   value="{{ isset($country->title) ? $country->getTitle->ru : old('title.ru')}}" required>
    ...
    <div class="tab-pane fade" id="custom-tabs-one-en" role="tabpanel" aria-labelledby="custom-tabs-one-en-tab">
        <div class="form-group col-md-6 {{ $errors->has('title.en') ? 'has-error' : ''}}">
            <label for="title_en" class="control-label">{{ 'Название страны En' }}</label>
            <input class="form-control" name="title[en]" type="text" id="title_en"
                   value="{{ isset($country->title) ? $country->getTitle->en : old('title.en')}}">
    ...
    <div class="tab-pane fade" id="custom-tabs-one-kz" role="tabpanel" aria-labelledby="custom-tabs-one-kz-tab">
        <div class="form-group col-md-6 {{ $errors->has('title.kz') ? 'has-error' : ''}}">
            <label for="title_kz" class="control-label">{{ 'Название страны Kz' }}</label>
            <input class="form-control" name="title[kz]" type="text" id="title_kz"
                   value="{{ isset($country->title) ? $country->getTitle->kz : old('title.kz')}}">
