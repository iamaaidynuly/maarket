...
<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            ...
            <li><a href="/admin/about-us-block?slug=loyalty"><i class="fa fa-window-restore"></i> Установка </a></li>
            <li><a href="/admin/about-us-block?slug=cooperation"><i class="fa fa-window-restore"></i> Партнеры</a></li>
            <li><a href="/admin/about-us-block?slug=delivery"><i class="fa fa-window-restore"></i> Доставка и самовывоз</a>
            </li>
