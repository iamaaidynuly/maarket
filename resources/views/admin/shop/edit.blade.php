@extends('adminlte::layout.main', ['title' => 'Редактирование магазина'])

@section('content')
    @component('adminlte::page', ['title' => 'Редактирование магазина'])
        @component('adminlte::box')
            ...
            <form method="POST" action="{{ route('shops.update', $shop->id) }}" accept-charset="UTF-8"
                  class="form-horizontal" enctype="multipart/form-data">
                {{ method_field('PATCH') }}
                {{ csrf_field() }}

                @include ('admin.shop.form', ['formMode' => 'edit'])
